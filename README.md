...
#### 下载最新完整版本：[天下书阁.apk](https://raw.githubusercontent.com/SemperChen/tianxiashuge/master/天下书阁.apk)
...
说到广告，想必大家都不陌生，因为我们生活无处不广告，但要说到广告盈利，就针对开发者而言，了解的人也是很少，因为广告盈利并不是一件简单的事，要想盈利得好，有着很长的路要走。
下面的是APP广告盈利教程，虽说App中植入广告来盈利是比较低级的商业化方式，但对于个人开发者来说，做一个简易的免费小软件，在里面植入一些广告，如果用的人多，也是可以带来一些可观的收入。

<img src="https://github.com/SemperChen/tianxiashuge/blob/master/image/i0.png"/>

看到以上图片你是不是很心动呢？这是我们团队最近一部分收入

好了废话不多说，以下便是教程购买网址，它将带领你走进广告盈利的门槛

### 教程
- 《React Native》Google Admob广告环境搭建
- 如何在GooglePlay和AppStore上发布应用
